...
| 齿顶倒圆 | Tip Fillet (ρ*_tip) | 齿顶与齿面之间的倒圆半径系数，ρ_tip = ρ\*_tip·m_n。**设计书参数字典未定义**（缺口 ADR-013）；默认 0 = 锐角齿顶（与现 3D 网格一致），>0 为预留能力，仅规格呈现层使用，不得当已验证公式。区别于已在设计书定义的**齿根圆角 ρ\*_f** 与当前齿形的**齿顶弧**（尖角弧，无倒圆） |
